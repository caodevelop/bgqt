angular.module('app').controller('SOUCtrl', function (AuthVerify, $scope, $http, $state, $stateParams, $location, $window) {
    $(".last-col").hide();
    ...
    //公司树
    $scope.GetSamelevelOuTree = function () {
        ...
        function getUrl(treeId, treeNode) {
            ...
            var Url = storage.getItem("InterfaceUrl") + 'TreeNode.ashx?op=GetSamelevelOuTree&accessToken=' + storage.getItem("userAdminToken") + '&NodeID=' + nodeid;
            return Url;
        }
        ...
        $scope.SearchSamelevelOuTree = function () {
            currentNodeID = '';
            $(".last-col").hide();
            if ($scope.seachNode == "" || $scope.seachNode == undefined || $scope.seachNode == null) {
                $scope.GetSamelevelOuTree();
            } else {
                var searchValue = $.trim($scope.seachNode);
                var myUrl = storage.getItem("InterfaceUrl") + 'TreeNode.ashx?op=SearchSamelevelOuTree&accessToken=' + storage.getItem("userAdminToken") + '&Searchstr=' + encodeURI(searchValue);
    ...
    $scope.AddOU = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=AddOu&accessToken=' + storage.getItem("userAdminToken"),
    ...
    $scope.ModifyOuPanel = function (ouid) {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=GetOuInfo&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            var callbackObj = response.data;
            if (callbackObj.result == "true") {
    ...
    $scope.ModifyOu = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=ModifyOu&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            angular.element(".preloader").css("display", "none");
            var callbackObj = response.data;
    ...
    $scope.MoveOu = function () {
        ...
        if ($scope.TargetOUNode == 0) {
            ErrorHandling('false', 0, '不能移动到根节点。');
            return;
        }
        var paramObj = {
            "TargetNode": { "NodeID": $scope.TargetOUNode },
            "NodeList": [{ "NodeID": $scope.MoveObjID, "Type": 1 }]
        }
        angular.element(".preloader").css("display", "block");
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=MoveOu&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            angular.element(".preloader").css("display", "none");
            var callbackObj = response.data;
    ...
    $scope.DeleteOu = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=DeleteOu&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            var callbackObj = response.data;
            if (callbackObj.result == "true") {
    ...
    $scope.AddGroup = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=AddGroup&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            angular.element(".preloader").css("display", "none");
            var callbackObj = response.data;
    ...
    $scope.ModifyGroupPanel = function (groupid) {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=GetGroupInfo&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            var callbackObj = response.data;
            if (callbackObj.result == "true") {
    ...
    $scope.ModifyGroup = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=ModifyGroup&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            angular.element(".preloader").css("display", "none");
            var callbackObj = response.data;
    ...
    $scope.DeleteGroup = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=DeleteGroup&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            var callbackObj = response.data;
            if (callbackObj.result == "true") {
    ...
    $scope.AddUser = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=AddUser&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            angular.element(".preloader").css("display", "none");
            var callbackObj = response.data;
    ...
    $scope.ModifyUserPanel = function (userid, op) {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=GetUserInfo&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            var callbackObj = response.data;
            if (callbackObj.result == "true") {
    ...
    $scope.ChangeUser = function (op) {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=ChangeUser&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            angular.element(".preloader").css("display", "none");
            var callbackObj = response.data;
    ...
    $scope.MoveUser = function () {
        ...
        var paramObj = {
            "TargetNode": { "NodeID": $scope.TargetOUNode },
            "NodeList": [{ "NodeID": $scope.MoveObjID }]
        }
        angular.element(".preloader").css("display", "block");
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=MoveNodes&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            angular.element(".preloader").css("display", "none");
            var callbackObj = response.data;
    ...
    $scope.GetUserExchangeInfo = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=GetUserExchangeInfo&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            var callbackObj = response.data;
            if (callbackObj.result == "true") {
    ...
    $scope.ChangeUserExchangeInfo = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=ChangeUserExchangeInfo&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            angular.element(".preloader").css("display", "none");
            var callbackObj = response.data;
    ...
    $scope.ChangeUserMemberof = function (op) {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=ChangeUserMemberof&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            angular.element(".preloader").css("display", "none");
            var callbackObj = response.data;
    ...
    $scope.GetGroupTree = function () {
        ...
        function getGroupUrl(treeId, treeNode) {
            ...
            var Url = storage.getItem("InterfaceUrl") + 'TreeNode.ashx?op=GetSamelevelOuGroupTree&accessToken=' + storage.getItem("userAdminToken") + '&NodeID=' + nodeid;
            return Url;
        }
        ...
        $scope.SearchGroupTree = function () {
            if ($scope.seachGroupNode == "" || $scope.seachGroupNode == undefined || $scope.seachGroupNode == null) {
                ...
                var myUrl = storage.getItem("InterfaceUrl") + 'TreeNode.ashx?op=SearchSamelevelOuGroupTree&accessToken=' + storage.getItem("userAdminToken") + '&Searchstr=' + encodeURI(searchValue);
                $http({ method: 'GET', url: myUrl }).success(
                    function (response) {
                        var obj = response;
                        if (response.result != "false") {
    ...
    $scope.EnableUser = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=EnableUser&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            var callbackObj = response.data;
            ErrorHandling(callbackObj.result, callbackObj.errCode, callbackObj.errMsg);
    ...
    $scope.DisableUser = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=DisableUser&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            var callbackObj = response.data;
            if (callbackObj.result == "true") {
    ...
    $scope.ResetPassword = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=ResetUserPassword&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            var callbackObj = response.data;
            if (callbackObj.result == "true") {
    ...
    $scope.DeleteUser = function () {
        ...
        $http({
            method: 'post',
            url: storage.getItem("InterfaceUrl") + 'SameLevelOu.ashx?op=DeleteUser&accessToken=' + storage.getItem("userAdminToken"),
            data: JSON.stringify(paramObj)
        }).then(function successCallback(response) {
            var callbackObj = response.data;
            if (callbackObj.result == "true") {
    ...
    $scope.GetOrgTree = function (treeStr) {
        ...
        function getOrgUrl(treeId, treeNode) {
            ...
            var Url = storage.getItem("InterfaceUrl") + 'TreeNode.ashx?op=GetSamelevelOuTreeOnlyOu&accessToken=' + storage.getItem("userAdminToken") + '&NodeID=' + nodeid;
            return Url;
        }
        ...
        $scope.SearchOrgTree = function () {
            if ($scope.seachOrgNode == "" || $scope.seachOrgNode == undefined || $scope.seachOrgNode == null) {
                ...
                var myUrl = storage.getItem("InterfaceUrl") + 'TreeNode.ashx?op=SearchSamelevelOuTreeOnlyOu&accessToken=' + storage.getItem("userAdminToken") + '&Searchstr=' + encodeURI(searchValue);
                $http({ method: 'GET', url: myUrl }).success(
                    function (response) {
                        var obj = response;
                        if (response.result != "false") {
